...
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'River Thames', 1);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Eiffel Tower', 2);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Clock Tower', 3);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Bridge', 4);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Clouds', 5);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Skyline', 6);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Coat', 7);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Hair', 8);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Clothing', 9);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('1', 'Background', 10);
...
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('2', 'Colorful Lights', 1);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('2', 'Ceiling', 2);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('2', 'Futuristic', 3);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('2', 'Floor', 4);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('2', 'Dim Lighting', 5);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('2', 'Mysterious Atmosphere', 6);
...
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Table', 1);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Chairs', 2);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Bottles', 3);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Glasses', 4);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Tablecloths', 5);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Wall', 6);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Lighting', 7);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('3', 'Background', 8);

INSERT INTO `gdg-demos.images.images` (user_id, album_id, image_id, datetime, description)
VALUES ('1', '1', '4', '2022-09-19',
"TThe image depicts a woman standing in front of the iconic Stonehenge, a prehistoric monument located in Wiltshire, England. The woman is dressed in a black jacket and a white dress, which adds a touch of elegance to the scene. She is holding a black umbrella, which serves as both a functional accessory and a stylish accent to her outfit.
The woman is standing on a grassy area, surrounded by a fence that encloses the monument. This fence helps to maintain the historical and cultural significance of the site, while also providing a sense of protection and preservation for the ancient structure.
Stonehenge itself is a remarkable feat of engineering and architecture, consisting of a series of massive stone pillars arranged in a circular pattern. The monument is believed to have been built over 5,000 years ago, and its purpose and meaning continue to be the subject of much debate and speculation among historians and archaeologists.
The woman's pose, with her arm extended and pointing towards the monument, conveys a sense of awe and appreciation for the historical and cultural significance of Stonehenge. The image captures a moment of contemplation and reflection, as the woman takes in the grandeur and beauty of the ancient structure.
...
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('4', 'Black Umbrella', 1);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('4', 'White dress', 2);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('4', 'Stone Monument', 3);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('4', 'Black Jacket', 4);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('4', 'Fence', 5);
INSERT INTO `gdg-demos.images.tags` (image_id, tag, priority) VALUES ('4', 'Grassy Area', 6);
